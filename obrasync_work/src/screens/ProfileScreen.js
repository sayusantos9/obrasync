...
const ToggleShell = styled.View`width: 52px; height: 38px; align-items: center; justify-content: center;`;
...
export function ProfileScreen() {
  const { openScreen, isOffline, setIsOffline, pendingRequests, sync, isSyncing } = useApp();
  return <Screen><Scroll><Header><Avatar><Ionicons name="person" size={38} color="#5A1B73" /></Avatar><Name>Emelly Santos</Name><Role>Gestora/Master • PLANENGEN</Role></Header><Content>
    <Menu onPress={() => openScreen(SCREENS.COMPANY_PERMISSIONS)}><MenuIcon><Ionicons name="business-outline" size={21} color="#5A1B73" /></MenuIcon><MenuText>Empresa e permissões</MenuText><Ionicons name="chevron-forward" size={20} color="#756D7A" /></Menu>
    <Menu><MenuIcon><Ionicons name="cloud-offline-outline" size={21} color="#E0A526" /></MenuIcon><MenuText>Modo offline</MenuText><ToggleShell><Toggle value={isOffline} onValueChange={setIsOffline} /></ToggleShell></Menu>
