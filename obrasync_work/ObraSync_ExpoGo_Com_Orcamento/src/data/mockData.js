...
export const defaultExpenses = [
  { id: 'EXP-001', name: 'Concreto usinado', date: '12 jun 2026', amount: 12450, category: 'Materiais', icon: 'construct', color: '#E0A526', backgroundColor: '#FFF4D6' },
  { id: 'EXP-002', name: 'Aço CA-50', date: '11 jun 2026', amount: 8320, category: 'Materiais', icon: 'cube', color: '#5A1B73', backgroundColor: '#EDE6F1' },
  { id: 'EXP-003', name: 'Frete de materiais', date: '10 jun 2026', amount: 2800, category: 'Frete', icon: 'car', color: '#2F9E7A', backgroundColor: '#E5F5EF' },
  { id: 'EXP-004', name: 'Mão de obra', date: '09 jun 2026', amount: 15600, category: 'Mão de obra', icon: 'people', color: '#B5473E', backgroundColor: '#FBE9E7' },
];
