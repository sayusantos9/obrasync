...
export function HomeScreen() {
  ...
  return <Screen><Scroll><AppHeader /><Content><SearchBar />
    ...
    {isLoading ? <ActivityIndicator color="#5A1B73" /> : <Metrics>
      <Metric onPress={() => selectTab(TABS.BUDGET)}><MetricIcon bg="#EDE6F1"><Ionicons name="calculator" size={22} color="#5A1B73" /></MetricIcon><MetricLabel>Orçamento</MetricLabel><MetricValue>R$ {Math.round(data.budget / 100000) / 10} mi</MetricValue></Metric>
