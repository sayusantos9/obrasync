...
import { calculateCostSummary } from '../utils/costs';
...
export function CostsScreen() {
  ...
  const costSummary = calculateCostSummary({
    budget: getProjectBudget(selectedProject.id),
        ...
        <Content>
          <View style={styles.totalCard}>
            ...
            <View style={styles.totalFooter}>
              ...
              <Text style={styles.smallText}>
                Limite: {formatCompactCurrency(budgetLimit)}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryCard}>
              ...
              <Text style={styles.summaryValue}>{formatCompactCurrency(budgetLimit)}</Text>
            </View>
          </View>
