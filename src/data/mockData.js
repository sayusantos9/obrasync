export const projects = [
  { id: '1', name: 'Residencial Aurora', city: 'São Luís - MA', progress: 68, status: 'Em andamento' },
  { id: '2', name: 'Centro Logístico Norte', city: 'Paço do Lumiar - MA', progress: 31, status: 'Atenção' },
  { id: '3', name: 'Edifício Mirante', city: 'São José de Ribamar - MA', progress: 12, status: 'Planejamento' },
];
